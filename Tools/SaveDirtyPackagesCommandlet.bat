...
REM Using "SaveDirtyPackages" commandlet
...
echo on
%UE4EDITOR% %UPROJECT% -run=SaveDirtyPackages -AutoCheckOut -AutoCheckin -unattended -LogCmds="LogSourceControl Verbose" -Log=SaveDirtyPackages.log
@echo off
if %errorlevel% neq 0 (
